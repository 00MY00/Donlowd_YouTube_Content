...
if "-help" in sys.argv or "--help" in sys.argv:
    ...
    print("===========================================")
    print('► Syntax : [DYTBC.exe] [-Format] ["URL"] ["URL"]')
    print("► Il est possible d'ajouter plusieur URL a la suite")
    exit()
...
try:
    ...
    if 'entries' in playlist_dict:
        ...
        # Téléchargement
        ydl.download(url)
        print(f"La playlist '{playlist_title}' a été téléchargée avec succès.")
    else:
...
# Compilation command
# pyinstaller --onefile --add-data "ffmpeg-6.0-full_build;ffmpeg-6.0-full_build" DYTBC.py
# Avec ICON
# pyinstaller --onefile --add-data "ffmpeg-6.0-full_build;ffmpeg-6.0-full_build" --icon DYTBC.ico DYTBC.py
